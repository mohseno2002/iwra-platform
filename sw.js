/* منصة مصلحة الري — عامل الخدمة v2.5.0
   قشرة التطبيق تُخزَّن للعمل دون اتصال؛ بيانات Firebase وGoogle Sheets تمر مباشرة دون اعتراض. */
var V='iwra-v2.5.0';
...
self.addEventListener('fetch',function(e){
 ...
 if(e.request.method!=='GET'||u.origin!==self.location.origin)return; /* المزامنة الحية لا تُعترض */
